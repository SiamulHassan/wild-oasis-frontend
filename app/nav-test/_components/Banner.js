			...
			<div className='bg-slate-800 text-sm p-3 md:rounded shadow flex justify-between'>
				<div className='text-slate-500 inline-flex'>
					<a
						...
						href='https://cruip.com/build-a-hoverable-dropdown-menu-with-tailwind-css-and-alpine-js/'
						target='_blank'
						rel='noreferrer'
					>
						Read Tutorial
					...
					<a
						...
						href='https://github.com/cruip/cruip-tutorials/blob/main/flyout-menu/index.html'
						target='_blank'
						rel='noreferrer'
					>
						<span>Download</span>
